...
public class ClientConnection extends javax.swing.JFrame{
    ...
    public void reset(){
        try{
            int defaut=1;
            Connecter();
            pst=con.prepareStatement("DELETE FROM customer_choice WHERE payment_confirmation='"+defaut+"'");
            pst.executeUpdate();
            con.close();
        }catch(Exception e){
                e.printStackTrace();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Please connect to your account");
        ...
        setSize(new java.awt.Dimension(824, 443));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        ClientConnection.super.dispose();
        menu Men=new menu();
        Men.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            pst = con.prepareStatement("SELECT * FROM cleint_r WHERE num_client='"+id+"' AND password='"+pass+"'");
            rs=pst.executeQuery();
            if(rs.next()){
                JOptionPane.showMessageDialog(null,"Successfully connected");
                ClientConnection.super.dispose();
                CarNaviguationClient cl=new CarNaviguationClient();
                cl.setVisible(true);
            }
            else{
                JOptionPane.showMessageDialog(null,"It seems that your id or password is false");
            }
